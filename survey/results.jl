...
# ╔═╡ a8b8a0a1-6202-4e9a-800e-a5696f893d8c
begin
	using CairoMakie
	using Makie
end

# ╔═╡ 59ab0cf8-8528-11ec-23b1-8f55636bbd90
md"""
# Survey results
...
3. Roughly what percentage of your overall work time is spent **developing** research software?
"""

# ╔═╡ de5b448f-56f9-477e-b232-f0ee49822bec
# Plot questions 2 and 3
begin

function plot_2_3()
    x = [10, 10, 30, 30, 50, 50, 70, 70, 90, 90]
    y = [13,  8, 9,   5,  7,  9,  5,  5,  4, 11]
    
    dodge = [ 1, 2, 1, 2, 1, 2, 1, 2, 1, 2]

    # Figure and Axis
    fig = Figure()
    ax = Axis(fig[1,1], 
		      xticks = (10:20:90, ["0-20%", "21-40%", "41-60%", "61-80%", "81-100%"]),
              yticks = 1:1:13,
              ylabel = "Responses",
              title = "Percentage of time using or developing software")
    ...
    Makie.save("BackgroundInfo.pdf", fig)
	fig
end
...
function plot_5_6()
    ...
    Makie.save("DevelopersInteractions.pdf", fig)
	fig
end
